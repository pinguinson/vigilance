...
import com.github.pinguinson.vigilance.{Report, PluginRunner}
import com.github.pinguinson.vigilance.inspections.unneccesary.UnusedMethodParameter
  ...
  "UnusedMethodParameter" - {
    ...
    "should handle constructor params" - {
      ...
      "warn on unused case class secondary params" in {
        ...
        compileCodeSnippet(code)
        compiler.vigilance.feedback.reports.size shouldBe 1
        compiler.vigilance.feedback.reports.head.comment should endWith("'y'")
      }
      ...
      "warn on unused non-case class primary params" in {
        ...
        compileCodeSnippet(code)
        compiler.vigilance.feedback.reports.size shouldBe 1
        compiler.vigilance.feedback.reports.head.comment should endWith("'x'")
      }
